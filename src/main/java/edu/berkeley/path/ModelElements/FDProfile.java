...
public class FDProfile extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.Map<java.lang.CharSequence,java.util.List<edu.berkeley.path.ModelElements.FD>> fd;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: fd = (java.util.Map<java.lang.CharSequence,java.util.List<edu.berkeley.path.ModelElements.FD>>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * map key is linkId, array is time series, as per dt and startTime.   */
  public java.util.Map<java.lang.CharSequence,java.util.List<edu.berkeley.path.ModelElements.FD>> getFd() {
    return fd;
  }
   ...
   */
  public void setFd(java.util.Map<java.lang.CharSequence,java.util.List<edu.berkeley.path.ModelElements.FD>> value) {
    this.fd = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FDProfile>
    ...
    private java.util.Map<java.lang.CharSequence,java.util.List<edu.berkeley.path.ModelElements.FD>> fd;
    ...
    private Builder(edu.berkeley.path.ModelElements.FDProfile other) {
      ...
      if (isValidValue(fields()[2], other.fd)) {
        this.fd = (java.util.Map<java.lang.CharSequence,java.util.List<edu.berkeley.path.ModelElements.FD>>) data().deepCopy(fields()[2].schema(), other.fd);
    ...
    /** Sets the value of the 'fd' field */
    public edu.berkeley.path.ModelElements.FDProfile.Builder setFd(java.util.Map<java.lang.CharSequence,java.util.List<edu.berkeley.path.ModelElements.FD>> value) {
    ...
    public FDProfile build() {
      try {
        ...
        record.fd = fieldSetFlags()[2] ? this.fd : (java.util.Map<java.lang.CharSequence,java.util.List<edu.berkeley.path.ModelElements.FD>>) defaultValue(fields()[2]);
        return record;
      } catch (Exception e) {
