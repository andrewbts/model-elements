...
public class FDSet extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** * map key is linkId */
  @Deprecated public java.util.Map<java.lang.String,edu.berkeley.path.model_elements_base.FDProfile> profile;
   ...
   */
  public FDSet(java.lang.String id, java.lang.String name, java.lang.String description, java.lang.String projectId, edu.berkeley.path.model_elements_base.FDType type, java.util.Map<java.lang.String,edu.berkeley.path.model_elements_base.FDProfile> profile, java.lang.Long modstamp) {
    this.id = id;
    this.name = name;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: profile = (java.util.Map<java.lang.String,edu.berkeley.path.model_elements_base.FDProfile>)value$; break;
   ...
   * * map key is linkId   */
  public java.util.Map<java.lang.String,edu.berkeley.path.model_elements_base.FDProfile> getProfile() {
    return profile;
  }
   ...
   */
  public void setProfile(java.util.Map<java.lang.String,edu.berkeley.path.model_elements_base.FDProfile> value) {
    this.profile = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FDSet>
    ...
    private java.util.Map<java.lang.String,edu.berkeley.path.model_elements_base.FDProfile> profile;
    ...
    private Builder(edu.berkeley.path.model_elements_base.FDSet other) {
      ...
      if (isValidValue(fields()[5], other.profile)) {
        this.profile = (java.util.Map<java.lang.String,edu.berkeley.path.model_elements_base.FDProfile>) data().deepCopy(fields()[5].schema(), other.profile);
    ...
    /** Sets the value of the 'id' field */
    public edu.berkeley.path.model_elements_base.FDSet.Builder setId(java.lang.String value) {
    ...
    /** Sets the value of the 'name' field */
    public edu.berkeley.path.model_elements_base.FDSet.Builder setName(java.lang.String value) {
    ...
    /** Sets the value of the 'description' field */
    public edu.berkeley.path.model_elements_base.FDSet.Builder setDescription(java.lang.String value) {
    ...
    /** Sets the value of the 'projectId' field */
    public edu.berkeley.path.model_elements_base.FDSet.Builder setProjectId(java.lang.String value) {
    ...
    /** Sets the value of the 'profile' field */
    public edu.berkeley.path.model_elements_base.FDSet.Builder setProfile(java.util.Map<java.lang.String,edu.berkeley.path.model_elements_base.FDProfile> value) {
    ...
    public FDSet build() {
      try {
        ...
        record.profile = fieldSetFlags()[5] ? this.profile : (java.util.Map<java.lang.String,edu.berkeley.path.model_elements_base.FDProfile>) defaultValue(fields()[5]);
