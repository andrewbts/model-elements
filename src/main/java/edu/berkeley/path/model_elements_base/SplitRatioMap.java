...
public class SplitRatioMap extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public SplitRatioMap(java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.lang.Double>>>> ratio) {
    this.ratio = ratio;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: ratio = (java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.lang.Double>>>>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SplitRatioMap>
    ...
    private java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.lang.Double>>>> ratio;
    ...
    private Builder(edu.berkeley.path.model_elements_base.SplitRatioMap other) {
      ...
      if (isValidValue(fields()[0], other.ratio)) {
        this.ratio = (java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.lang.Double>>>>) data().deepCopy(fields()[0].schema(), other.ratio);
    ...
    /** Sets the value of the 'ratio' field */
    public edu.berkeley.path.model_elements_base.SplitRatioMap.Builder setRatio(java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.lang.Double>>>> value) {
    ...
    public SplitRatioMap build() {
      try {
        ...
        record.ratio = fieldSetFlags()[0] ? this.ratio : (java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,java.lang.Double>>>>) defaultValue(fields()[0]);
        return record;
      } catch (Exception e) {
