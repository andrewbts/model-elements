...
/** * PeMS sensor data set, organized as a time-series
   ...
   * is generated at multiples of 30 seconds. */
public class PeMSSet extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public PeMSSet(java.util.List<edu.berkeley.path.model_elements_base.PeMSMap> pemsSeries) {
    this.pemsSeries = pemsSeries;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: pemsSeries = (java.util.List<edu.berkeley.path.model_elements_base.PeMSMap>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }

  /**
   * Gets the value of the 'pemsSeries' field.
   */
  public java.util.List<edu.berkeley.path.model_elements_base.PeMSMap> getPemsSeries() {
    return pemsSeries;
  }

  /**
   * Sets the value of the 'pemsSeries' field.
   * @param value the value to set.
   */
  public void setPemsSeries(java.util.List<edu.berkeley.path.model_elements_base.PeMSMap> value) {
    this.pemsSeries = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PeMSSet>
    ...
    private java.util.List<edu.berkeley.path.model_elements_base.PeMSMap> pemsSeries;
    ...
    private Builder(edu.berkeley.path.model_elements_base.PeMSSet other) {
            super(edu.berkeley.path.model_elements_base.PeMSSet.SCHEMA$);
      if (isValidValue(fields()[0], other.pemsSeries)) {
        this.pemsSeries = (java.util.List<edu.berkeley.path.model_elements_base.PeMSMap>) data().deepCopy(fields()[0].schema(), other.pemsSeries);
    ...
    /** Sets the value of the 'pemsSeries' field */
    public edu.berkeley.path.model_elements_base.PeMSSet.Builder setPemsSeries(java.util.List<edu.berkeley.path.model_elements_base.PeMSMap> value) {
    ...
    /** Checks whether the 'pemsSeries' field has been set */
    public boolean hasPemsSeries() {
      return fieldSetFlags()[0];
    }
    
    /** Clears the value of the 'pemsSeries' field */
    public edu.berkeley.path.model_elements_base.PeMSSet.Builder clearPemsSeries() {
      pemsSeries = null;
    ...
    public PeMSSet build() {
      try {
        ...
        record.pemsSeries = fieldSetFlags()[0] ? this.pemsSeries : (java.util.List<edu.berkeley.path.model_elements_base.PeMSMap>) defaultValue(fields()[0]);
        return record;
      } catch (Exception e) {
