...
public class Node extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Node(java.lang.String id, java.lang.String name, java.lang.String type, edu.berkeley.path.model_elements_base.Point point) {
    this.id = id;
    this.name = name;
    this.type = type;
    this.point = point;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Node>
    ...
    /** Sets the value of the 'id' field */
    public edu.berkeley.path.model_elements_base.Node.Builder setId(java.lang.String value) {
    ...
    /** Sets the value of the 'name' field */
    public edu.berkeley.path.model_elements_base.Node.Builder setName(java.lang.String value) {
    ...
    /** Sets the value of the 'type' field */
    public edu.berkeley.path.model_elements_base.Node.Builder setType(java.lang.String value) {
