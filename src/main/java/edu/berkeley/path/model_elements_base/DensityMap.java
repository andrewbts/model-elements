...
public class DensityMap extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DensityMap\",\"namespace\":\"edu.berkeley.path.model_elements_base\",\"doc\":\"* Density on each link at a point in time\",\"fields\":[{\"name\":\"vehiclesPerMeter\",\"type\":{\"type\":\"map\",\"values\":\"double\"},\"doc\":\"map key is linkId\",\"default\":{}}]}");
  /** map key is linkId */
   ...
   */
  public DensityMap(java.util.Map<java.lang.CharSequence,java.lang.Double> vehiclesPerMeter) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: vehiclesPerMeter = (java.util.Map<java.lang.CharSequence,java.lang.Double>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DensityMap>
    ...
    private Builder(edu.berkeley.path.model_elements_base.DensityMap other) {
      ...
      if (isValidValue(fields()[0], other.vehiclesPerMeter)) {
        this.vehiclesPerMeter = (java.util.Map<java.lang.CharSequence,java.lang.Double>) data().deepCopy(fields()[0].schema(), other.vehiclesPerMeter);
    ...
    /** Sets the value of the 'vehiclesPerMeter' field */
    public edu.berkeley.path.model_elements_base.DensityMap.Builder setVehiclesPerMeter(java.util.Map<java.lang.CharSequence,java.lang.Double> value) {
    ...
    public DensityMap build() {
      try {
        ...
        record.vehiclesPerMeter = fieldSetFlags()[0] ? this.vehiclesPerMeter : (java.util.Map<java.lang.CharSequence,java.lang.Double>) defaultValue(fields()[0]);
        return record;
      } catch (Exception e) {
