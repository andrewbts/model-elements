...
public class NetworkRef extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"NetworkRef\",\"namespace\":\"edu.berkeley.path.model_elements_base\",\"fields\":[{\"name\":\"networkId\",\"type\":\"string\"}]}");
  ...
  public static edu.berkeley.path.model_elements_base.NetworkRef.Builder newBuilder() {
    return new edu.berkeley.path.model_elements_base.NetworkRef.Builder();
  }
  
  /** Creates a new NetworkRef RecordBuilder by copying an existing Builder */
  public static edu.berkeley.path.model_elements_base.NetworkRef.Builder newBuilder(edu.berkeley.path.model_elements_base.NetworkRef.Builder other) {
    return new edu.berkeley.path.model_elements_base.NetworkRef.Builder(other);
  }
  
  /** Creates a new NetworkRef RecordBuilder by copying an existing NetworkRef instance */
  public static edu.berkeley.path.model_elements_base.NetworkRef.Builder newBuilder(edu.berkeley.path.model_elements_base.NetworkRef other) {
    return new edu.berkeley.path.model_elements_base.NetworkRef.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NetworkRef>
    ...
    private Builder() {
      super(edu.berkeley.path.model_elements_base.NetworkRef.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(edu.berkeley.path.model_elements_base.NetworkRef.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing NetworkRef instance */
    private Builder(edu.berkeley.path.model_elements_base.NetworkRef other) {
            super(edu.berkeley.path.model_elements_base.NetworkRef.SCHEMA$);
    ...
    /** Sets the value of the 'networkId' field */
    public edu.berkeley.path.model_elements_base.NetworkRef.Builder setNetworkId(java.lang.CharSequence value) {
    ...
    public edu.berkeley.path.model_elements_base.NetworkRef.Builder clearNetworkId() {
      networkId = null;
