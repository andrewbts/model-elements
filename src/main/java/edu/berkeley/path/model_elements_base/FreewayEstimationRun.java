...
public class FreewayEstimationRun extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   * Default constructor.
   */
  public FreewayEstimationRun() {}

  /**
   * All-args constructor.
   */
  public FreewayEstimationRun(java.lang.CharSequence id, java.lang.CharSequence name, java.lang.CharSequence contextId, java.util.List<java.lang.Long> seeds, edu.berkeley.path.model_elements_base.ProcessConfig process) {
    this.id = id;
    this.name = name;
  ...
  /** Creates a new FreewayEstimationRun RecordBuilder */
  public static edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder newBuilder() {
    return new edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder();
  }
  
  /** Creates a new FreewayEstimationRun RecordBuilder by copying an existing Builder */
  public static edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder newBuilder(edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder other) {
    return new edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder(other);
  }
  
  /** Creates a new FreewayEstimationRun RecordBuilder by copying an existing FreewayEstimationRun instance */
  public static edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder newBuilder(edu.berkeley.path.model_elements_base.FreewayEstimationRun other) {
    return new edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder(other);
  }
  
  /**
   * RecordBuilder for FreewayEstimationRun instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FreewayEstimationRun>
    implements org.apache.avro.data.RecordBuilder<FreewayEstimationRun> {
    ...
    private Builder() {
      super(edu.berkeley.path.model_elements_base.FreewayEstimationRun.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing FreewayEstimationRun instance */
    private Builder(edu.berkeley.path.model_elements_base.FreewayEstimationRun other) {
            super(edu.berkeley.path.model_elements_base.FreewayEstimationRun.SCHEMA$);
    ...
    /** Sets the value of the 'id' field */
    public edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder setId(java.lang.CharSequence value) {
    ...
    public edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder clearId() {
      id = null;
    ...
    /** Sets the value of the 'name' field */
    public edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder setName(java.lang.CharSequence value) {
    ...
    public edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'contextId' field */
    public edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder setContextId(java.lang.CharSequence value) {
    ...
    public edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder clearContextId() {
      contextId = null;
    ...
    /** Sets the value of the 'seeds' field */
    public edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder setSeeds(java.util.List<java.lang.Long> value) {
    ...
    public edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder clearSeeds() {
      seeds = null;
    ...
    /** Sets the value of the 'process' field */
    public edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder setProcess(edu.berkeley.path.model_elements_base.ProcessConfig value) {
    ...
    public edu.berkeley.path.model_elements_base.FreewayEstimationRun.Builder clearProcess() {
      process = null;
    ...
    @Override
    public FreewayEstimationRun build() {
      try {
        FreewayEstimationRun record = new FreewayEstimationRun();
