...
public class VelocityProfile extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static edu.berkeley.path.model_elements_base.VelocityProfile.Builder newBuilder() {
    return new edu.berkeley.path.model_elements_base.VelocityProfile.Builder();
  }
  
  /** Creates a new VelocityProfile RecordBuilder by copying an existing Builder */
  public static edu.berkeley.path.model_elements_base.VelocityProfile.Builder newBuilder(edu.berkeley.path.model_elements_base.VelocityProfile.Builder other) {
    return new edu.berkeley.path.model_elements_base.VelocityProfile.Builder(other);
  }
  
  /** Creates a new VelocityProfile RecordBuilder by copying an existing VelocityProfile instance */
  public static edu.berkeley.path.model_elements_base.VelocityProfile.Builder newBuilder(edu.berkeley.path.model_elements_base.VelocityProfile other) {
    return new edu.berkeley.path.model_elements_base.VelocityProfile.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<VelocityProfile>
    ...
    private Builder() {
      super(edu.berkeley.path.model_elements_base.VelocityProfile.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(edu.berkeley.path.model_elements_base.VelocityProfile.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing VelocityProfile instance */
    private Builder(edu.berkeley.path.model_elements_base.VelocityProfile other) {
            super(edu.berkeley.path.model_elements_base.VelocityProfile.SCHEMA$);
    ...
    /** Sets the value of the 'id' field */
    public edu.berkeley.path.model_elements_base.VelocityProfile.Builder setId(java.lang.CharSequence value) {
    ...
    public edu.berkeley.path.model_elements_base.VelocityProfile.Builder clearId() {
      id = null;
    ...
    public edu.berkeley.path.model_elements_base.VelocityProfile.Builder clearMetersPerSecond() {
