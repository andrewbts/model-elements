...
public class FreewayContextConfig extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public FreewayContextConfig(java.lang.CharSequence id, java.lang.CharSequence name, java.lang.CharSequence runMode, java.lang.CharSequence workflow, java.lang.CharSequence ctmType, java.lang.CharSequence fdType, java.lang.Double additiveModelNoiseMean, java.lang.Double additiveModelNoiseStdDev, java.lang.CharSequence enkfType, edu.berkeley.path.model_elements_base.EnKFParams enkfParams, edu.berkeley.path.model_elements_base.Duration dtOutput, edu.berkeley.path.model_elements_base.Duration dt, edu.berkeley.path.model_elements_base.DateTime timeBegin, edu.berkeley.path.model_elements_base.DateTime timeEnd) {
    this.id = id;
    this.name = name;
  ...
  public java.lang.Object get(int field$) {
    ...
    case 8: return enkfType;
    case 9: return enkfParams;
    case 10: return dtOutput;
    case 11: return dt;
    case 12: return timeBegin;
    case 13: return timeEnd;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 8: enkfType = (java.lang.CharSequence)value$; break;
    case 9: enkfParams = (edu.berkeley.path.model_elements_base.EnKFParams)value$; break;
    case 10: dtOutput = (edu.berkeley.path.model_elements_base.Duration)value$; break;
    case 11: dt = (edu.berkeley.path.model_elements_base.Duration)value$; break;
    case 12: timeBegin = (edu.berkeley.path.model_elements_base.DateTime)value$; break;
    case 13: timeEnd = (edu.berkeley.path.model_elements_base.DateTime)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FreewayContextConfig>
    ...
    private Builder(edu.berkeley.path.model_elements_base.FreewayContextConfig other) {
      ...
      if (isValidValue(fields()[8], other.enkfType)) {
        this.enkfType = (java.lang.CharSequence) data().deepCopy(fields()[8].schema(), other.enkfType);
        fieldSetFlags()[8] = true;
      }
      if (isValidValue(fields()[9], other.enkfParams)) {
        this.enkfParams = (edu.berkeley.path.model_elements_base.EnKFParams) data().deepCopy(fields()[9].schema(), other.enkfParams);
        fieldSetFlags()[9] = true;
      }
      if (isValidValue(fields()[10], other.dtOutput)) {
        this.dtOutput = (edu.berkeley.path.model_elements_base.Duration) data().deepCopy(fields()[10].schema(), other.dtOutput);
        fieldSetFlags()[10] = true;
      }
      if (isValidValue(fields()[11], other.dt)) {
        this.dt = (edu.berkeley.path.model_elements_base.Duration) data().deepCopy(fields()[11].schema(), other.dt);
        fieldSetFlags()[11] = true;
      }
      if (isValidValue(fields()[12], other.timeBegin)) {
        this.timeBegin = (edu.berkeley.path.model_elements_base.DateTime) data().deepCopy(fields()[12].schema(), other.timeBegin);
        fieldSetFlags()[12] = true;
      }
      if (isValidValue(fields()[13], other.timeEnd)) {
        this.timeEnd = (edu.berkeley.path.model_elements_base.DateTime) data().deepCopy(fields()[13].schema(), other.timeEnd);
    ...
    public FreewayContextConfig build() {
      try {
        ...
        record.enkfType = fieldSetFlags()[8] ? this.enkfType : (java.lang.CharSequence) defaultValue(fields()[8]);
        record.enkfParams = fieldSetFlags()[9] ? this.enkfParams : (edu.berkeley.path.model_elements_base.EnKFParams) defaultValue(fields()[9]);
        record.dtOutput = fieldSetFlags()[10] ? this.dtOutput : (edu.berkeley.path.model_elements_base.Duration) defaultValue(fields()[10]);
        record.dt = fieldSetFlags()[11] ? this.dt : (edu.berkeley.path.model_elements_base.Duration) defaultValue(fields()[11]);
        record.timeBegin = fieldSetFlags()[12] ? this.timeBegin : (edu.berkeley.path.model_elements_base.DateTime) defaultValue(fields()[12]);
        record.timeEnd = fieldSetFlags()[13] ? this.timeEnd : (edu.berkeley.path.model_elements_base.DateTime) defaultValue(fields()[13]);
        return record;
      } catch (Exception e) {
