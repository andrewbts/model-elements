...
public class FreewayContextConfig extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public edu.berkeley.path.model_elements_base.SensorSet sensors;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 17: sensors = (edu.berkeley.path.model_elements_base.SensorSet)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public edu.berkeley.path.model_elements_base.SensorSet getSensors() {
    return sensors;
  }
   ...
   * @param value the value to set.
   */
  public void setSensors(edu.berkeley.path.model_elements_base.SensorSet value) {
    this.sensors = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FreewayContextConfig>
    ...
    private edu.berkeley.path.model_elements_base.SensorSet sensors;
    ...
    private Builder(edu.berkeley.path.model_elements_base.FreewayContextConfig other) {
      ...
      if (isValidValue(fields()[17], other.sensors)) {
        this.sensors = (edu.berkeley.path.model_elements_base.SensorSet) data().deepCopy(fields()[17].schema(), other.sensors);
    ...
    /** Sets the value of the 'sensors' field */
    public edu.berkeley.path.model_elements_base.FreewayContextConfig.Builder setSensors(edu.berkeley.path.model_elements_base.SensorSet value) {
    ...
    public edu.berkeley.path.model_elements_base.FreewayContextConfig.Builder clearSensors() {
      sensors = null;
    ...
    public FreewayContextConfig build() {
      try {
        ...
        record.sensors = fieldSetFlags()[17] ? this.sensors : (edu.berkeley.path.model_elements_base.SensorSet) defaultValue(fields()[17]);
        return record;
      } catch (Exception e) {
