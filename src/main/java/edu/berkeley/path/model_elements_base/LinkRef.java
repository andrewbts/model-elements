...
public class LinkRef extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LinkRef\",\"namespace\":\"edu.berkeley.path.model_elements_base\",\"fields\":[{\"name\":\"linkId\",\"type\":\"string\"}]}");
  ...
  public static edu.berkeley.path.model_elements_base.LinkRef.Builder newBuilder() {
    return new edu.berkeley.path.model_elements_base.LinkRef.Builder();
  }
  
  /** Creates a new LinkRef RecordBuilder by copying an existing Builder */
  public static edu.berkeley.path.model_elements_base.LinkRef.Builder newBuilder(edu.berkeley.path.model_elements_base.LinkRef.Builder other) {
    return new edu.berkeley.path.model_elements_base.LinkRef.Builder(other);
  }
  
  /** Creates a new LinkRef RecordBuilder by copying an existing LinkRef instance */
  public static edu.berkeley.path.model_elements_base.LinkRef.Builder newBuilder(edu.berkeley.path.model_elements_base.LinkRef other) {
    return new edu.berkeley.path.model_elements_base.LinkRef.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LinkRef>
    ...
    private Builder() {
      super(edu.berkeley.path.model_elements_base.LinkRef.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(edu.berkeley.path.model_elements_base.LinkRef.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing LinkRef instance */
    private Builder(edu.berkeley.path.model_elements_base.LinkRef other) {
            super(edu.berkeley.path.model_elements_base.LinkRef.SCHEMA$);
    ...
    /** Sets the value of the 'linkId' field */
    public edu.berkeley.path.model_elements_base.LinkRef.Builder setLinkId(java.lang.CharSequence value) {
    ...
    public edu.berkeley.path.model_elements_base.LinkRef.Builder clearLinkId() {
      linkId = null;
